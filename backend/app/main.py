...
from app.api.ai_engine_proxy_routes import (
    asr_proxy_router,
    conversation_proxy_router,
    nlp_proxy_router,
    translate_proxy_router,
)
...
# Proxy endpoints to AI engine (Option A gateway pattern).
app.include_router(nlp_proxy_router)
app.include_router(asr_proxy_router)
app.include_router(translate_proxy_router)
