...
async def create_visit_route(
    ...
    if supabase is None:
        ...
        return {
            "visit_id": visit.get("id") or visit_id,
            "id": visit.get("id") or visit_id,
            "patient_id": payload.patient_id,
            "visit_status": visit.get("visit_status") or payload.visit_status or "open",
            "created_at": visit.get("created_at") or "",
            "visit_date": (visit.get("created_at") or "")[:10] if visit.get("created_at") else "",
            "visit_time": "",
        }
    try:
